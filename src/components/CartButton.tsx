...
export function CartButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-gold)] text-[var(--color-ink)] shadow-lg transition-transform hover:-translate-y-0.5 md:bottom-8 md:right-8"
    >
